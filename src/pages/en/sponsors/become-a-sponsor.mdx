...
<div>
    <a className="p-button" target="_blank" href="/sponsorship-prospectus-en.pdf">Sponsorship prospectus(PDF)</a>
    <a className="p-button" target="_blank" href="https://forms.gle/voqyyGmRxHDCho6W7">Submit sponsor form</a>
</div>
